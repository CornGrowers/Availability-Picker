...
1.	Go to entra.microsoft.com (or
...
`https://login.microsoftonline.com/{your-tenant-id}/adminconsent?client\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_id={existing-client-id}`.
...
In `config.js`, set:
```js
clientId: "THE\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_CLIENT\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_ID\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_FROM\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_STEP\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_1",
...
README.md for how the current GitHub Pages hosting works, if
you're keeping it).
Hosting
...
·	`<ProviderName>` — currently a placeholder (`REPLACE\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_WITH\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_YOUR\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_ORG\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\_NAME`);
...
1.	Go to admin.microsoft.com → Settings
→ Integrated apps.
